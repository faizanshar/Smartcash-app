            ...
            <View style = {styles.container}>
                ...
                refreshControl={
                    ...
                    <View style = {styles.viewprofil}>
                        ...
                        <TouchableOpacity style = {styles.touchclose} onPress = {()=>this.props.navigation.closeDrawer()}>
                            <Image source = {require('../Assets/Whitearrow.png')} style = {styles.imgclose}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <TouchableOpacity style = {styles.touch} onPress = {()=>this.props.navigation.navigate("Profilestaff",{item:this.state.data})}>
                    ...
                    <TouchableOpacity style = {styles.touch2}>
                        <View style = {styles.viewicon}>
                            <Image source = {require('../Assets/graylogout.png')} style = {styles.imgprofile}/>
                        </View>
                        <View style = {styles.view}>

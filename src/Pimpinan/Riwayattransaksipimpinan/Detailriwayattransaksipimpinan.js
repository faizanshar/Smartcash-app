...
import {styles} from './Styledetailriwayattransaksipimpinan';
import AsyncStorage from '@react-native-community/async-storage';
import {connect} from 'react-redux';


class Detailriwayattransaksipimpinan extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data:[]
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps)(Detailriwayattransaksipimpinan);
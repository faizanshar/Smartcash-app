...
import {styles} from './Styleriwayattransaksipimpinan';
import AsyncStorage from '@react-native-community/async-storage';
import {connect} from 'react-redux';
import LottieView from 'lottie-react-native';

class Riwayattransaksipimpinan extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() =>
                        this.props.navigation.navigate(
                          'Detailriwayattransaksipimpinan',
                          {item: v},
                        )
                      }>
...
export default connect(mapStateToProps)(Riwayattransaksipimpinan);

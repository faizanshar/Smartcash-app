...
import {styles} from './Styleprofilepimpinan';
import {connect} from 'react-redux';
import LottieView from 'lottie-react-native';

class Profilepimpinan extends Component {
  constructor() {
    super();
    this.state = {
      nama: '',
      ...
      <View style={styles.container}>
        <ScrollView>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              this.props.navigation.navigate('Fotopimpinan', {
...
export default connect(mapStateToProps)(Profilepimpinan);

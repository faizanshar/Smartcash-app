...
import {styles} from './Styleperusahaanpimpinan.js';
import AsyncStorage from '@react-native-community/async-storage';
import {connect} from 'react-redux';
import LottieView from 'lottie-react-native';

class Perusahaanpimpinan extends Component {
  constructor() {
    super();
    this.state = {
      data: [],
            ...
            <View style={styles.header}>
              ...
              <View style={styles.header2}>
                ...
                {/* <TouchableOpacity
                  ...
                  onPress={() =>
                    this.props.navigation.navigate('Tambahperusahaanpimpinan')
                  }>
                  <Image
...
export default connect(mapStateToProps)(Perusahaanpimpinan);

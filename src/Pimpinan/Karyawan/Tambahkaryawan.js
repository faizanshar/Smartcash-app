...
import {styles} from './Styletambah';
...
class Tambahkaryawan extends Component {
  ...
  tambahMember = () => {
    ...
    fetch('https://smartcash2.herokuapp.com/api/karyawan/add', {
      method: 'POST',
      headers: {
        ...
        <ScrollView>
          ...
          <View style={styles.viewkategori}>
            <Picker
              ...
              <Picker.Item label={'Kasir'} value={4} />
            </Picker>
          </View>
          <TextInput
            placeholder={' Alamat'}
...
export default connect(mapStateToProps)(Tambahkaryawan);

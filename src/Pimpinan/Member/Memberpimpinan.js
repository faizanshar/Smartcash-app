...
import {styles} from './Stylememberpimpinan';
import AsyncStorage from '@react-native-community/async-storage';
import {connect} from 'react-redux';
import LottieView from 'lottie-react-native';

class Memberpimpinan extends Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  getMember() {
    ...
    fetch('https://smartcash2.herokuapp.com/api/member', {
      method: 'GET',
      headers: {
        ...
        {this.state.loading !== false ? (
          ...
          <ScrollView
            ...
            <View style={styles.header}>
              ...
              <Text style={styles.txtgudang}>Member</Text>
            </View>
...
export default connect(mapStateToProps)(Memberpimpinan);

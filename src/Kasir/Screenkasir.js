...
export default class Screenkasir extends Component {

    onSuccess = e => {
        alert(e.data)
        console.log('INI COBA',e);
      };
    render() {
        return (
                ...
                <ScrollView>
                    ...
                    <View style = {styles.header}>
                        <View style = {styles.viewprofil}>
                            <Text style = {styles.txtname}>Faiz</Text>
                             <Text style = {styles.txtnomor}>0821312312</Text>
                        </View>
                        <TouchableOpacity style = {styles.touchfoto}>
                            <Image 

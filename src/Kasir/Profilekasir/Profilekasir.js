...
class Profilekasir extends Component {
  ...
  resendEmail() {
    ...
    fetch('https://smartcash2.herokuapp.com/api/email/resend', {
      method: 'GET',
      headers: {
        Accept: 'application/json',
        Authorization: `Bearer ${this.props.userToken.userReducer.token}`,
      ...
      .then((responseJson) => {
        ...
        if (responseJson.status == 'success') {
          ToastAndroid.show(
            'Email vertifikasi sudah dikirim Ke email anda!',
            2000,
          );
      ...
      <View style={styles.container}>
        <ScrollView>
          ...
          {this.state.verify == null ? (
            <View
              ...
              <Text style={{fontSize: 14, fontWeight: 'bold', marginLeft: 15}}>
                Email anda belum di vertifikasi!
              </Text>
              <TouchableOpacity
                ...
                {this.state.loading2 == false ? (
                  <Text
                    ...
                    Vertifikasi Sekarang!
                  </Text>
                ) : (
                  <LottieView
                    source={require('../../Assets/6541-loading.json')}
                    autoPlay={true}
                    style={{width: '50%', height: 45, marginLeft: 10}}
                  />
                )}
              </TouchableOpacity>
            </View>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              this.props.navigation.navigate('Fotokasir', {
